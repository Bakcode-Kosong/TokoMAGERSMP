  ...
  >
    ...
    <div class="row main">
      <div class="col-lg p-3 divide">
        <div class="fw-bold text-white text-start">Medan</div>
        <div class="d-flex position-relative status-cuaca">
          <img class="berawan" alt="berawan" src="/img/berawan.png" />
          <div class="status text-white px-4 ps-5 fs-1">Badai, -12° C</div>
        </div>
        <div class="line"></div>
        <div class="text-white text-start px-2 fs-1 fw-semibold">
          Jaga Diri Kelen :)
        </div>
      </div>
